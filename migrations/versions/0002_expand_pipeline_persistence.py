...
def upgrade() -> None:
    ...
    op.add_column(
        "tasks",
        sa.Column("selected_sources", sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")),
    )
    op.add_column("tasks", sa.Column("max_papers", sa.Integer(), nullable=False, server_default="50"))
    op.add_column(
        "tasks", sa.Column("max_iterations", sa.Integer(), nullable=False, server_default="3")
    )
    op.add_column(
        "tasks", sa.Column("iterations_used", sa.Integer(), nullable=False, server_default="0")
    )

    op.add_column(
        "tasks",
        sa.Column("progress_subtasks_total", sa.Integer(), nullable=False, server_default="0"),
    )
    op.add_column(
        "tasks",
        sa.Column("progress_subtasks_completed", sa.Integer(), nullable=False, server_default="0"),
    )
    op.add_column(
        "tasks",
        sa.Column("progress_papers_collected", sa.Integer(), nullable=False, server_default="0"),
    )
    op.add_column(
        "tasks",
        sa.Column("progress_findings_generated", sa.Integer(), nullable=False, server_default="0"),
    )
